...
import User from "../utilites/hooks.model"
// ------------------------------------------- //
...
function DisplayUser() {
    /**declare users as state variable */
    ...
    */
    const handleRemoveUser = (id: number) => {
        ...
        /**
         * line 55,56 trigger diffrent state changes 
         * React will queue both setter function and process that changes and replace that in only one render 
         * Rather than doing render for every setter funtion react complited it in onces that called as "Batching"
         */
